...
document.addEventListener('DOMContentLoaded', () => {
            ...
            cardContainer.innerHTML += `
                <div class="pelapak-card ${cardClass}">
                    ...
                    <div class="pelapak-body">
                        ...
                        <div class="item"><span>A1</span><strong>${row.a1}</strong></div>
                        <div class="item"><span>A2</span><strong>${row.a2}</strong></div>
                        <div class="item"><span>A3</span><strong>${row.a3}</strong></div>
                        <div class="item"><span>A4</span><strong>${row.a4}</strong></div>
                        <div class="item full">
                            <span>Total</span>
    ...
    // =============================
    // MODAL GAMBAR KAOS (AMAN)
    // =============================
    const kaosImage = document.getElementById('kaosImage');
    const modal = document.getElementById('imageModal');
    const modalImg = document.getElementById('modalImg');
    const closeBtn = document.querySelector('.close');

    if (kaosImage && modal && modalImg && closeBtn) {
        kaosImage.addEventListener('click', () => {
            modal.classList.remove('hidden');
            modalImg.src = kaosImage.src;
        });
