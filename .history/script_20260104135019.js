    ...
    function renderCard(data) {
      ...
      <div class="pelapak-card">
        ...
        <div class="pelapak-body">
          ...
          <div class="item">
            <span>Angsuran 1</span>
            <strong>${row.a1}</strong>
          </div>

          <div class="item">
            <span>Angsuran 2</span>
            <strong>${row.a2}</strong>
          </div>

          <div class="item">
            <span>Angsuran 3</span>
            <strong>${row.a3}</strong>
          </div>

          <div class="item">
            <span>Angsuran 4</span>
            <strong>${row.a4}</strong>
          </div>
